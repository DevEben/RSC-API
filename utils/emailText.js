const generateDynamicEmail = (businessName, otp) => {
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;"> Welcome On Board , ${businessName},<br/>Below is your One Time Password (OTP) to verify your account.</h3>
                                <p><a href="" class="btn btn-primary" style="padding: 10px 25px; display: inline-block; border-radius: 3px; background: #0098e1; color: #ffffff; text-decoration: none; font-size: 30px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 500;">${otp}</a></p>
                                <h5 style="font-family: 'Lato', sans-serif; font-size: 18px; font-weight: 300;">Please <a href="https://rapid-stock-control.onrender.com/#/verify"> click here </a> to verify your account with the provided OTP</h5> 
