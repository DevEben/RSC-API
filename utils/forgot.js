const resetFunc = (businessName, link) => {
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;"> Dear ${businessName},<br/>Click the button below to reset your password.</h3>
                                <p><a href=${link} class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 3px; background: #0098e1; color: #ffffff; text-decoration: none;">Reset</a></p>
